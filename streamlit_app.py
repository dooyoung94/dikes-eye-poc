...
/* Streamlit 1.61 border container: style the wrapper itself, not only its first child */
div[data-testid="stVerticalBlockBorderWrapper"]{{background:linear-gradient(rgba(255,252,244,.985),rgba(255,252,244,.985)),url('{PARCHMENT}') center/cover!important;border:1px solid #d7bd8b!important;border-radius:20px!important;box-shadow:0 14px 34px rgba(62,43,23,.16)!important;padding:.35rem!important;backdrop-filter:none!important}}
div[data-testid="stVerticalBlockBorderWrapper"]>div{{background:transparent!important}}
/* Conversation/form panel must stay opaque over the photographic Agora */
...
.section-title{{display:inline-block;font-size:1.2rem;font-weight:850;letter-spacing:-.025em;margin:.65rem 0 .28rem;padding:.42rem .68rem;color:#241d15;background:rgba(255,248,234,.96);border:1px solid rgba(201,168,94,.55);border-radius:11px;box-shadow:0 5px 14px rgba(70,49,25,.10);text-shadow:none}}
...
.context{{background:linear-gradient(rgba(255,250,239,.99),rgba(255,250,239,.99)),url('{INPUT_TEXTURE}') center/cover;border:1px solid #d5b97f;border-radius:16px;padding:.78rem;margin:.65rem 0;box-shadow:0 6px 18px rgba(92,70,37,.09)}}
...
[data-testid="stExpander"]{{border:1px solid #d5c09a;border-radius:14px;background:#fffaf2}}
